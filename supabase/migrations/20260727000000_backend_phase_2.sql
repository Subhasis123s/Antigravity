-- ====================================================================
-- ANTIGRAVITY AI WORKSPACE — BACKEND PHASE 2 MIGRATION SCHEMA
-- Production Authentication, User Profiles, Workspaces, RBAC & Logs
-- ====================================================================
...
-- --------------------------------------------------------------------
-- 5. USER SESSIONS & DEVICE TRACKING TABLE
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- 7. AUTOMATIC NEW USER SIGNUP PROVISIONING TRIGGER (FAILSAFE)
-- --------------------------------------------------------------------
